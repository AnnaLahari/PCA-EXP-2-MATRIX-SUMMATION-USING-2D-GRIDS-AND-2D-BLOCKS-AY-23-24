...
<h3>AIM:
To perform matrix summation with a 2D grid and 2D blocks and adapting it to integer matrix addition.</h3>
...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/16ef8183-f5db-47b5-8e45-e9fa8f24eaa7)

## RESULT:
The host took 0.857531 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.013692 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
